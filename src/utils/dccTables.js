...
export const abilityScoreModifiers = {
  3: { modifier: -3, wizardSpellsKnown: 0, maxSpellLevel: 0 },
  4: { modifier: -2, wizardSpellsKnown: -2, maxSpellLevel: 1 },
  5: { modifier: -2, wizardSpellsKnown: -2, maxSpellLevel: 1 },
  6: { modifier: -1, wizardSpellsKnown: -1, maxSpellLevel: 1 },
  7: { modifier: -1, wizardSpellsKnown: -1, maxSpellLevel: 1 },
  8: { modifier: -1, wizardSpellsKnown: 0, maxSpellLevel: 2 },
  9: { modifier: 0, wizardSpellsKnown: 0, maxSpellLevel: 2 },
  10: { modifier: 0, wizardSpellsKnown: 0, maxSpellLevel: 3 },
  11: { modifier: 0, wizardSpellsKnown: 0, maxSpellLevel: 3 },
  12: { modifier: 0, wizardSpellsKnown: 0, maxSpellLevel: 4 },
  13: { modifier: 1, wizardSpellsKnown: 0, maxSpellLevel: 4 },
  14: { modifier: 1, wizardSpellsKnown: 1, maxSpellLevel: 4 },
  15: { modifier: 1, wizardSpellsKnown: 1, maxSpellLevel: 5 },
  16: { modifier: 2, wizardSpellsKnown: 1, maxSpellLevel: 5 },
  17: { modifier: 2, wizardSpellsKnown: 2, maxSpellLevel: 5 },
  18: { modifier: 3, wizardSpellsKnown: 2, maxSpellLevel: 5 },
};

const luckScoreHealingNote =
...
const luckScoreCritFumbleNote =
  "Luck normally affects critical hits and fumbles. On this result, the" +
  " modifier is doubled for purposes of crits or fumbles.";

export const luckScore = {
  1: {
    birthAugur: "Harsh Winter",
    luckyRoll: "All attack rolls",
  },
  2: {
    birthAugur: "The bull",
    luckyRoll: "Melee attack rolls",
  },
  3: {
    birthAugur: "Fortunate date",
    luckyRoll: "Missile fire attack rolls",
  },
  4: {
    birthAugur: "Raised by wolves",
    luckyRoll: "Unarmed attack rolls",
  },
  5: {
    birthAugur: "Conceived on horseback",
    luckyRoll: "Mounted attack rolls",
  },
  6: {
    birthAugur: "Born on the battlefield",
    luckyRoll: "Damage rolls",
  },
  7: {
    birthAugur: "Path of the bear",
    luckyRoll: "Melee damage rolls",
  },
  8: {
    birthAugur: "Hawkeye",
    luckyRoll: "Missile fire damage rolls",
  },
  9: {
    birthAugur: "Pack hunter",
    luckyRoll: "Attack and damage rolls for 0-level starting weapon",
  },
  10: {
    birthAugur: "Born under the loom",
    luckyRoll: "Skill checks (including thief skills)",
  },
  11: {
    birthAugur: "Fox's cunning",
    luckyRoll: "Find/disable traps",
  },
  12: {
    birthAugur: "Four-leafed clover",
    luckyRoll: "Find secret doors",
  },
  13: {
    birthAugur: "Seventh son",
    luckyRoll: "Spell checks",
  },
  14: {
    birthAugur: "The raging storm",
    luckyRoll: "Spell damage",
  },
  15: {
    birthAugur: "Righteous heart",
    luckyRoll: "Turn unholy checks",
  },
  16: {
  ...
  17: {
    ...
    luckyRoll: "Saving throws",
  },
  18: {
    birthAugur: "Guardian angel",
    luckyRoll: "Saving throws to escape traps",
  },
  19: {
    birthAugur: "Survived a spider bite",
    luckyRoll: "Saving throws against poison",
  },
  20: {
    birthAugur: "Struck by lightning",
    luckyRoll: "Reflex saving throws",
  },
  21: {
    birthAugur: "Lived through famine",
    luckyRoll: "Fortitude saving throws",
  },
  22: {
    birthAugur: "Resisted temptation",
    luckyRoll: "Willpower saving throws",
  },
  23: {
    birthAugur: "Charmed house",
    luckyRoll: "Armor class",
  },
  24: {
    birthAugur: "Speed of the cobra",
    luckyRoll: "Initiative",
  },
  25: {
    birthAugur: "Bountiful harvest",
    luckyRoll: "Hit points (applies at each level)",
  },
  26: {
  ...
  29: {
    birthAugur: "Birdsong",
    luckyRoll: "Number of languages",
  },
  30: {
    birthAugur: "Wild child",
    luckyRoll: "Speed (each +1/-1 = +5'/-5' speed)",
  },
};
...
const languageTables = {
  ...
  warrior: [
    ...
    { min: 21, max: 30, language: "Dwarf" },
    { min: 31, max: 35, language: "Elf" },
    { min: 36, max: 38, language: "Halfling" },
    { min: 39, max: 43, language: "Bugbear" },
    { min: 44, max: 53, language: "Goblin" },
    { min: 54, max: 58, language: "Gnoll" },
    { min: 59, max: 63, language: "Harpy" },
    { min: 64, max: 70, language: "Hobgoblin" },
    { min: 71, max: 78, language: "Kobold" },
    { min: 79, max: 81, language: "Lizard Man" },
    { min: 82, max: 83, language: "Minotaur" },
    { min: 84, max: 88, language: "Ogre" },
    { min: 89, max: 95, language: "Orc" },
    { min: 96, max: 96, language: "Serpent-Man" },
    { min: 97, max: 98, language: "Troglodyte" },
    { min: 99, max: Infinity, language: "Giant" },
  ],
};
...
const weaponTableTwoHandedNote =
  "Two-handed weapon. Characters using two-handed weapons use a d16 on" +
  " initiative checks.";

const weaponTableCloseRangeNote =
  "Strength modifier applies to damage with this wepon at close range only.";

const weaponTableSurpriseNote =
  "These weapons are particularly effective when used with the element of" +
  " surprise. A thief who succeeds in a backstab attempt with one of these" +
  " weapons uses the second damage value listed. All other classes and all" +
  " other thief attacks use the first value.";

const weaponTableDaggerNote =
  "Characters generally purchase normal straight-edged daggers, but" +
  " cultists, cave-dwellers, evil priests, alien worshipers, and other" +
  " menacing villains carry curvy or ceremonial daggers known as athame," +
  " kris, or tumi.";

const weaponTableMountedNote =
  "These weapons inflict double damage on a mounted charge. A lance can only" +
  " be used when mounted.";

const weaponTable = {
  battleaxe: {
    damage: {
      main: { rolls: 1, sides: 10 },
    },
    range: "",
    gpCost: 7,
    notes: [weaponTableTwoHandedNote],
  },
};
